...
const products = [
  ...
  { name: 'Organic Bell Peppers', description: 'Mixed color organic bell peppers', category: 'vegetables', subcategory: 'organic', price: 449, unit: 'lb', isOrganic: true, isLocal: false, isSeasonal: false, carbonFootprint: 0.4, calories: 31, protein: 1, carbs: 7.2, fat: 0.3, brand: 'Organic Valley', imageUrl: 'https://images.unsplash.com/photo-1525607551316-5a9e1c8b3c8c?w=400&h=300&fit=crop', images: [{ url: 'https://images.unsplash.com/photo-1525607551316-5a9e1c8b3c8c?w=800&h=600&fit=crop', alt: 'Bell peppers', isPrimary: true }] },
  ...
  { name: 'Local Strawberries', description: 'Fresh local strawberries', category: 'fruits', subcategory: 'local', price: 399, unit: 'pack', isOrganic: false, isLocal: true, isSeasonal: true, carbonFootprint: 0.1, calories: 32, protein: 0.7, carbs: 7.7, fat: 0.3, brand: 'Local Farm Co', imageUrl: 'https://images.pexels.com/photos/1464965911861-746a04b4bca6?w=400&h=300&fit=crop', images: [{ url: 'https://images.pexels.com/photos/1464965911861-746a04b4bca6?w=800&h=600&fit=crop', alt: 'Strawberries', isPrimary: true }] },
